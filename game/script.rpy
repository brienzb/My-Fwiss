...
label start:
    ...
    ne "어여 짐도 싸고 준비도 하고,, 가족들이랑 친구들한테도 말해두어야 하고,,\n아 맞다! 회사도 휴가 써야하는데..."
    ...
    ne "야경도 너무 예쁘다 ㅎㅎ"
    ne "좀있으면 반짝인다고도 하는데"
    ne "같이 사온 피자와 와인이랑 둥동탑 구경을 즐겨봐야지~~"
    ...
    ne "으어어어ㅓ.."
    ne "벌써 아침인가..??"
    ne "아 맞다! 오늘 아침 일찍부터 가야할 빵집이 있어서 알람을 이른 시간에 맞춰놨지?"
    ne "어디보자 지금 시간이.."
    ...
    ne "지금까지 가본 프위스 장소 중에 제일 평화로운거 같아~~"
    ...
    ne "누가 해외에서 베이컨이랑 삼겹살 잘 구분해서 사라고 했는데"
    ...
    ne "오케이!! 가즈아~~"
    ne "(주문하기 위해 웨이터에게 열심히 눈빛으로 싸인을 보내는 중 O.O)"
